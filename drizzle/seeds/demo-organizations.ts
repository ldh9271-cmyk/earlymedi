...
export const DEMO_USERS = [
  ...
  },
  {
    ...
    email: 'demo-agency@koreaglowup.test',
  ...
  },
  {
    ...
    email: 'demo-freelancer@koreaglowup.test',
  ...
  },
  {
    ...
    email: 'demo-medical@koreaglowup.test',
  ...
  },
  {
    ...
    email: 'demo-partner@koreaglowup.test',
...
export const DEMO_ORGS = [
  {
    ...
    partnerSubtype: null,
    name: 'KoreaGlowUp 데모 에이전시',
    legalName: '주식회사 KoreaGlowUp 데모',
    slug: 'demo-agency',
    countryCode: 'KR',
    timezone: 'Asia/Seoul',
    defaultLocale: 'ko',
  ...
  },
  {
    ...
    partnerSubtype: null,
    name: 'KoreaGlowUp 데모 성형외과',
    legalName: '의료법인 KoreaGlowUp 데모',
    slug: 'demo-clinic',
    countryCode: 'KR',
    timezone: 'Asia/Seoul',
    defaultLocale: 'ko',
  ...
  },
  {
    ...
    name: 'KoreaGlowUp 회복호텔',
    legalName: 'KoreaGlowUp 호스피탈리티',
    slug: 'demo-hotel',
    countryCode: 'KR',
    timezone: 'Asia/Seoul',
    defaultLocale: 'ko',
