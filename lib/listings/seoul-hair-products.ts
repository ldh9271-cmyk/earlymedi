...
export const SEOUL_HAIR_PRODUCTS: ReadonlyArray<HairShopSeed> = [
  ...
  },
  {
    ...
    description:
      '강남역 3번 출구 도보 1분, 전국 단위 미용 프랜차이즈 리안헤어의 강남역 지점. 카카오헤어샵 평점 4.7 / 리뷰 598건으로 강남권 헤어샵 중 검증된 후기 규모를 갖췄다. 남성 컷 ₩18,000 · 여성 컷 ₩23,000, 펌 ₩48,000~ · 염색 ₩35,000~ 으로 강남 주요 프랜차이즈 평균 대비 저렴해 "강남 한복판 가성비"가 강점 — 청담 셀럽 살롱이 부담스러운 첫 방문 외국인에게 적합하다. 1:1 디자이너 맞춤 상담으로 컷·일반펌·열펌(매직/디지털)·염색·탈색·클리닉·드라이 스타일링까지 전 메뉴를 갖췄고, 프랜차이즈 표준 교육을 거친 디자이너가 응대한다. 카카오헤어샵 앱으로 사전 예약 가능.',
    ...
    priceRange: '컷 ₩18,000~ / 펌 ₩25,000~ / 염색 ₩35,000~ / 클리닉 ₩50,000~',
    ...
    priceTable: [
      {
        ...
        items: [
          ...
          { name: '여성 커트', won: 23_000 },
          { name: '컷 + 다운펌', won: 38_000 },
          { name: '컷 + 전체다운펌', won: 48_000 },
        ],
      },
      {
        group: '일반펌',
        items: [
          ...
          { name: '일반펌 (남성)', won: 48_000 },
          { name: '일반펌 (여성)', won: 55_000 },
        ],
      },
      {
        group: '열펌',
        items: [
          { name: '뿌리매직 (남성)', won: 40_000 },
          { name: '뿌리매직 (여성)', won: 60_000 },
          { name: '매직 (남성)', won: 63_000 },
          { name: '아이롱 펌 (남성)', won: 68_000 },
          { name: '볼륨매직 (남성)', won: 68_000 },
          { name: '디지털펌 (여성)', won: 68_000 },
          { name: '매직 (여성)', won: 76_000 },
          { name: '디지털 매직 셋팅 (여성)', won: 86_000 },
        ],
      },
      {
        group: '염색·탈색',
        items: [
          { name: '뿌리염색', won: 35_000 },
          { name: '전체 염색 (남성)', won: 60_000 },
          { name: '전체 염색 (여성)', won: 76_000 },
          { name: '뿌리 탈색 (남성)', won: 55_000 },
          { name: '뿌리 탈색 (여성)', won: 70_000 },
          { name: '전체 탈색 (남성)', won: 80_000 },
          { name: '전체 탈색 (여성)', won: 86_000 },
        ],
      },
      {
        group: '클리닉',
        items: [
          { name: '시술 추가 Z클리닉', won: 30_000 },
          { name: '기본 3단계 클리닉 (베이직 케어)', won: 50_000 },
          { name: '기본 6단계 클리닉 (리페어 케어)', won: 70_000 },
          { name: '클리닉 (프리미엄 리페어 케어)', won: 130_000 },
        ],
      },
      {
        group: '스타일링',
    ...
    priceNote: '오픈이벤트 최대 38% 할인 진행 중 — 적용 기간·조건은 매장 문의. 가격은 변동될 수 있습니다.',
    priceWon: 18_000,
