...
const en: Dictionary = {
  ...
  login: {
    badge: 'For Patients',
    title: 'Your schedule, recovery & payments',
    subtitle:
      "We'll send a secure magic link to the email your clinic registered. No password required.",
    emailLabel: 'Email',
    ...
    noAccount: "Don't have a medical-tourism plan yet?",
