...
export type HairShopSeed = {
  ...
  hours?: string;
  /**
   * 매장 공식 가격표 — 확인된 곳만. details.priceTable 로 저장돼
   * 상세페이지에 그룹별 표로 렌더된다. 금액은 원 단위 정수.
   */
  priceTable?: ReadonlyArray<{
    group: string;
    items: ReadonlyArray<{ name: string; won: number }>;
  }>;
  /** 가격표 아래 단서 — 이벤트·추가요금 등. details.priceNote. */
  priceNote?: string;
  /** ₩ 표시용 가격 (하한값 — 컷 기준). */
  priceWon: number;
...
export const SEOUL_HAIR_PRODUCTS: ReadonlyArray<HairShopSeed> = [
  ...
  },
  {
    ...
    description:
      '강남역 9번 출구 도보 2분, 전국 단위 미용 프랜차이즈 리안헤어의 강남역 지점. 카카오헤어샵 평점 4.7 / 리뷰 598건으로 강남권 헤어샵 중 검증된 후기 규모를 갖췄다. 남성 컷 ₩18,000 · 여성 컷 ₩23,000(샴푸+블로우 드라이 포함), 펌 ₩25,000~ · 염색 ₩35,000~ 으로 강남 주요 프랜차이즈 평균 대비 저렴해 "강남 한복판 가성비"가 강점 — 청담 셀럽 살롱이 부담스러운 첫 방문 외국인에게 적합하다. 컷·일반펌·열펌(매직/디지털)·염색·탈색·클리닉·드라이 스타일링까지 남녀 전 메뉴를 1:1 디자이너 맞춤 상담으로 진행한다. 단, 컷 외 시술은 기장에 따라 ₩20,000(단발)~₩40,000(가슴 라인 이상) 가산되므로 머리가 길다면 예상 금액을 미리 확인하는 편이 좋다. 카카오헤어샵 앱으로 사전 예약 가능.',
    locationLabel: '서초동 (강남역)',
    address: '서울 서초구 서초대로77길 9 301호 리안헤어 강남역점',
    phone: '02-3453-7910',
    station: '2호선·신분당선 강남역 9번 출구 도보 2분',
    services: '컷 · 일반펌 · 열펌(매직·디지털) · 염색 · 탈색 · 클리닉 · 드라이 스타일링',
    priceRange: '컷 ₩18,000~ / 펌 ₩25,000~ / 염색 ₩35,000~ / 클리닉 ₩50,000~ (기장 추가 ₩20,000~40,000 별도)',
    hours: '10:30~21:30 (시술별 예약 마감 상이 · 주말·공휴일 조기 마감)',
    priceTable: [
      {
        group: 'CUT — 커트 (전 시술 샴푸 포함)',
        items: [
          { name: '앞머리 커트', won: 5_000 },
          { name: '남성 커트', won: 18_000 },
          { name: '여성 커트 (샴푸 + 블로우 드라이 포함)', won: 23_000 },
        ],
      },
      {
        group: "WOMEN'S PERM — 여성 펌",
        items: [
          { name: '앞머리 펌 (디지털펌은 +₩20,000)', won: 30_000 },
          { name: '일반펌', won: 55_000 },
          { name: '뿌리 매직 (5cm 기준)', won: 60_000 },
          { name: '디지털펌', won: 68_000 },
          { name: '매직', won: 76_000 },
          { name: '디지털 매직셋팅', won: 86_000 },
        ],
      },
      {
        group: "WOMEN'S COLOR — 여성 염색·탈색",
        items: [
          { name: '뿌리 염색 (3~4cm 기준)', won: 35_000 },
          { name: '뿌리 탈색', won: 70_000 },
          { name: '전체 염색', won: 76_000 },
          { name: '전체 탈색', won: 86_000 },
        ],
      },
      {
        group: "MEN'S PERM — 남성 펌",
        items: [
          { name: '다운펌 (단독)', won: 25_000 },
          { name: '앞머리 펌', won: 30_000 },
          { name: '커트 + 다운펌 (정가 ₩43,000)', won: 38_000 },
          { name: '뿌리 매직', won: 40_000 },
          { name: '일반펌', won: 48_000 },
          { name: '커트 + 전체 다운펌 (정가 ₩58,000)', won: 48_000 },
          { name: '매직', won: 63_000 },
          { name: '볼륨매직', won: 68_000 },
          { name: '아이롱 펌', won: 68_000 },
        ],
      },
      {
        group: "MEN'S COLOR — 남성 염색·탈색",
        items: [
          { name: '뿌리 염색 (3~4cm 기준)', won: 35_000 },
          { name: '뿌리 탈색', won: 55_000 },
          { name: '전체 염색', won: 60_000 },
          { name: '전체 탈색', won: 80_000 },
        ],
      },
      {
        group: 'CLINIC — 클리닉',
        items: [
          { name: '시술 추가 클리닉', won: 30_000 },
          { name: '기본 3단계 (베이직 케어)', won: 50_000 },
          { name: '기본 6단계 (리페어 케어)', won: 70_000 },
          { name: '프리미엄 클리닉 (프리미엄 리페어 케어)', won: 130_000 },
        ],
      },
      {
        group: 'DRY — 드라이 스타일링',
        items: [
          { name: '블로우 드라이 스타일링', won: 25_000 },
          { name: '아이롱 드라이 스타일링', won: 30_000 },
        ],
      },
      {
        // 롱헤어 외국인 고객이 가장 자주 놓치는 항목 — 별도 그룹으로
        // 띄워 최종 결제액을 미리 가늠할 수 있게 한다.
        group: '기장 추가요금 (숏컷 라인 기준 0원 · 컷 외 시술에 가산)',
        items: [
          { name: '단발 라인', won: 20_000 },
          { name: '어깨 라인', won: 30_000 },
          { name: '가슴 라인 이상', won: 40_000 },
        ],
      },
    ],
    priceNote:
      '· 기장 추가는 약제량이 아니라 기술·소요시간 차이에 대한 가산입니다. 단발~어깨 라인 약 2시간, 가슴 라인 이상 약 3시간 30분+α 소요.\n'
      + '· 가슴 라인 이상은 ₩40,000부터이며 기장에 따라 더 올라갈 수 있습니다.\n'
      + '· 멤버십 정액권 — 30만원권 +10% / 60만원권 +15% / 90만원권 +20% 추가 적립, 정액권으로 시술 시 15% 추가 할인. 유효기간 1년, 커트는 할인 제외.\n'
      + '· 오픈이벤트 최대 38% 할인 진행 중 — 적용 기간·조건은 매장 문의.\n'
      + '· 프리미엄 제품으로 변경하면 시술 비용이 추가될 수 있고, 모든 시술은 기장·제품에 따라 가격이 변동될 수 있습니다.',
    priceWon: 18_000,
    foreignerSupport: '카카오헤어샵 예약 가능 (영어 응대 사전 문의)',
    promoLabel: '강남역 가성비 · 평점 4.7',
    seoTitle: '리안헤어 강남역점 | 강남역 가성비 헤어샵 | GlowUpTour',
    seoDescription:
      '강남역 9번 출구 도보 2분. 컷 ₩18,000~ / 펌 ₩25,000~ / 염색 ₩35,000~ 가성비. 카카오헤어샵 평점 4.7·리뷰 598건. GlowUpTour에서 예약.',
    seoTags: ['강남역헤어샵', '리안헤어', '가성비미용실', '강남컷', '프랜차이즈미용실', 'Gangnam hair salon', 'affordable haircut Seoul', 'Korean haircut Gangnam', '외국인헤어샵'],
    ogDescription: '강남역 헤어 | 리안헤어·역 도보 2분·컷 ₩18,000~ 가성비 — GlowUpTour',
  },
];
