...
const MOBILE_CSS = '@media (max-width: 768px) {'
  ...
  + '.m-mh-cat-strip { display: grid !important; grid-template-columns: repeat(5, 1fr) !important; row-gap: 4px !important; column-gap: 4px !important; padding: 6px 8px !important; overflow: visible !important; }'
