...
export const SEOUL_HAIR_PRODUCTS: ReadonlyArray<HairShopSeed> = [
  ...
  },
  {
    ...
    description:
      '강남역 3번 출구 도보 1분, 전국 단위 미용 프랜차이즈 리안헤어의 강남역 지점. 카카오헤어샵 평점 4.7 / 리뷰 598건으로 강남권 헤어샵 중 검증된 후기 규모를 갖췄다. 남성 컷 ₩18,000 · 여성 컷 ₩23,000(샴푸+블로우 드라이 포함), 펌 ₩25,000~ · 염색 ₩35,000~ 으로 강남 주요 프랜차이즈 평균 대비 저렴해 "강남 한복판 가성비"가 강점 — 청담 셀럽 살롱이 부담스러운 첫 방문 외국인에게 적합하다. 컷·일반펌·열펌(매직/디지털)·염색·탈색·클리닉·드라이 스타일링까지 남녀 전 메뉴를 1:1 디자이너 맞춤 상담으로 진행한다. 단, 컷 외 시술은 기장에 따라 ₩20,000(단발)~₩40,000(가슴 라인 이상) 가산되므로 머리가 길다면 예상 금액을 미리 확인하는 편이 좋다. 카카오헤어샵 앱으로 사전 예약 가능.',
    ...
    seoDescription:
      '강남역 3번 출구 도보 1분. 컷 ₩18,000~ / 펌 ₩25,000~ / 염색 ₩35,000~ 가성비. 카카오헤어샵 평점 4.7·리뷰 598건. GlowUpTour에서 예약.',
