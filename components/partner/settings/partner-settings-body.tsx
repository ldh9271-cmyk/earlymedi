    ...
    <div className="mx-auto max-w-7xl space-y-8 px-2 py-2 md:px-4">
      ...
      <SettingsShell sections={SECTIONS} accentClass="text-foreground">
        <SettingsSectionAnchor id="business">
          ...
          >
            ...
            <SettingsRow label="업체명">
              <Input defaultValue="글로우업투어 회복호텔" className="rounded-md" />
            </SettingsRow>
            <SettingsRow label="법인명">
              <Input defaultValue="글로우업투어 호스피탈리티" className="rounded-md" />
            </SettingsRow>
          ...
          >
            ...
            <SettingsRow label="입금 계좌 (KRW)">
              <div className="space-y-1">
                ...
                <div className="text-[11px] text-muted-foreground">예금주: 글로우업투어 호스피탈리티</div>
              </div>
            </SettingsRow>
        ...
        <SettingsSectionAnchor id="contracts">
          ...
          >
            <PartnerContractRow agency="글로우업투어 데모 에이전시" commission="GMV의 15%" priority="우선 노출" status="active" />
