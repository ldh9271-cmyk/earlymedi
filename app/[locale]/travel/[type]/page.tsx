...
const TRAVEL_CONTENT: Record<TravelType, TravelTypeContent> = {
  ...
  package: {
    ...
    priceUnitEn: 'person',
    priceUnitKr: '1인',
    priceNote: '4박 5일 풀패키지 · 1인 기준',
    highlights: [
      { icon: 'expert', title: 'All-inclusive 4-night trip', desc: '호텔·시술·맛집·K-팝 투어가 한 패키지에. 도착부터 귀국까지 일정 고정.' },
      { icon: 'concierge', title: 'Dedicated concierge', desc: '전담 컨시어지가 통역·이동·예약·후속 케어까지 한 번에 챙겨드려요.' },
      { icon: 'check', title: 'No charge until confirmed', desc: 'Free cancellation up to 48h. 예약 확정 전 무료 취소.' },
    ],
    includes: [
      '명동 5성 호텔 4박 (조식 포함)',
      '퍼스널 컬러 + 피부 진단 + 화보 촬영',
      '한우구이 + 한정식 등 미슐랭 다이닝 3회',
      'HYBE / SM / JYP / YG 4사 K-팝 성지 투어',
      '공항 픽업·드롭 + 전 일정 통역 가이드',
    ],
  ...
  training: {
    ...
    priceUnitEn: 'person',
    priceUnitKr: '1인',
    priceNote: '5–10일 연수 · 1인 기준 (숙박 포함)',
    highlights: [
      ...
      { icon: 'check', title: 'Customizable schedule', desc: '5일 / 7일 / 10일 옵션. 단체·기업 요청 시 맞춤 커리큘럼 구성.' },
    ],
    includes: [
      '클리닉 견학 3–5곳 (성형 · 피부 · 치과 · 모발 등)',
      '전문가 워크숍 + 수료증',
      '4성급 이상 숙박 + 조식',
      '의료 통역 전담 (EN / 中 / 日 / 露)',
      '공항 픽업·드롭 + 단체 차량 이동',
