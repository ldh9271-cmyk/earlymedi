...
export const metadata = { title: '설정 디자인 쇼룸' };
...
/**
 * Public-route mirror of the Agency settings page for design preview.
 * Identical layout / components / copy as /agency/settings, but rendered
 * without the auth gate so it can be viewed in the browser preview without
 * a real Supabase project. NOT a backdoor — read-only, demo-only data.
 */
export default function ShowroomSettingsPage(): JSX.Element {
  return (
    <div className="mx-auto max-w-7xl space-y-8 px-4 py-10 md:px-8">
      <div className="rounded-full bg-foreground px-4 py-1.5 text-center text-[11px] font-medium uppercase tracking-[0.14em] text-background md:inline-flex md:px-5">
        Design Showroom · 인증 없이 보기 · 데모 데이터
      </div>
      ...
      <SettingsHero
        ...
        actions={
          <>
            ...
            <Button variant="brand" className="rounded-full">저장</Button>
          </>
        }
      />
      ...
      <SettingsPromoCard
        ...
        variant="brand"
        cta={<Button className="rounded-full bg-white text-brand-700 hover:bg-white/90">플랜 비교</Button>}
      />
      ...
      <SettingsShell sections={SECTIONS} accentClass="text-brand-700">
          ...
          >
            ...
            <SettingsRow label="국가 · 타임존" hint="환자 발송 시각·세금 처리 기준">
              <div className="flex flex-wrap items-center gap-2">
                <Badge variant="secondary" className="rounded-full">KR · Asia/Seoul</Badge>
                <span className="text-xs text-muted-foreground">변경하려면 매니저에게 문의</span>
              </div>
            </SettingsRow>
            <SettingsRow label="기본 통화">
              <Badge variant="secondary" className="rounded-full">KRW (₩)</Badge>
            </SettingsRow>
          </SettingsCard>
        </SettingsSectionAnchor>
        ...
        <SettingsSectionAnchor id="billing">
          <SettingsCard
            ...
            action={<Button variant="outline" className="rounded-full">플랜 변경</Button>}
          >
            ...
            <SettingsRow label="월 구독료"><span className="font-semibold">₩299,000 / 월</span></SettingsRow>
            ...
            <SettingsRow label="다음 청구">
              <div className="space-y-0.5">
                ...
                <div className="text-[11px] text-muted-foreground">결제 수단: Visa ···· 4242 · 만료 02/28</div>
              </div>
            </SettingsRow>
        ...
        <SettingsSectionAnchor id="team">
          <SettingsCard
            ...
            action={<Button variant="brand" className="rounded-full">+ 멤버 초대</Button>}
          >
        ...
        <SettingsSectionAnchor id="integrations">
          <SettingsCard title="채널 · 통합" description="10채널 다국어 인박스 + 결제 · 환율 · 메시지 게이트웨이.">
        ...
        <SettingsSectionAnchor id="tax">
          <SettingsCard title="세금 · 정산 계좌" description="VAT 처리, 원천세, 정산 계좌. 모든 변경은 audit log에 기록됩니다.">
        ...
        <SettingsSectionAnchor id="security">
          <SettingsCard title="보안 · 감사" description="모든 PII / PHI 접근은 audit_logs에 기록되며 10년 보존됩니다 (의료법 27조의2).">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <SettingsTile href="/pricing" title="요금제 비교" body="Agency 3-tier (Starter / Growth / Pro) 비교." />
            <SettingsTile href="/showroom/settings#integrations" title="채널 통합 가이드" body="KakaoTalk · WhatsApp · LINE · WeChat 연결 가이드." />
            <SettingsTile href="/showroom/settings#api" title="API 사용량 한도" body="rate-limit · 무사용 회수 정책." />
            <SettingsTile href="/showroom/settings#security" title="감사 로그 정책" body="audit_logs 10년 보존, 의료법 27조의2 준수." />
          </div>
        </div>
      </SettingsShell>
    </div>
