/**
 * 한국 공휴일 정적 목록 (대체공휴일 포함) — 공공데이터포털 특일정보 API 가
 * 아직 승인되지 않았거나 실패했을 때의 대비용. kr_holidays 테이블에 API 값이
 * 들어오면 그쪽이 우선한다. 연도가 바뀌면 여기에 다음 해를 추가한다.
 */
export const KR_HOLIDAYS_STATIC: Record<string, string> = {
  // 2026
  '2026-01-01': '신정',
