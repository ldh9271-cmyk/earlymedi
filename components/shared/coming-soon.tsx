    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        <div className="mb-2 flex items-center gap-2">
          ...
          <span className="text-xs text-muted-foreground">글로우업투어 로드맵</span>
        </div>
      ...
      <div className="flex items-center justify-between rounded-lg border bg-muted/30 px-4 py-3 text-xs text-muted-foreground">
        ...
        <Link
          href="mailto:ldh9271@gmail.com?subject=%EA%B8%80%EB%A1%9C%EC%9A%B0%EC%97%85%ED%88%AC%EC%96%B4%20%EA%B8%B0%EB%8A%A5%20%EC%9A%94%EC%B2%AD"
