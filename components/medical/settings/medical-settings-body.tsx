    ...
    <div className="mx-auto max-w-7xl space-y-8 px-2 py-2 md:px-4">
      ...
      <SettingsShell sections={SECTIONS} accentClass="text-care-700">
        <SettingsSectionAnchor id="hospital">
          ...
          >
            <SettingsRow label="병원명" hint="환자에게 노출되는 명칭">
              <Input defaultValue="글로우업투어 데모 성형외과" className="rounded-md" />
            </SettingsRow>
            <SettingsRow label="의료법인명">
              <Input defaultValue="의료법인 글로우업투어 데모" className="rounded-md" />
            </SettingsRow>
          ...
          >
            ...
            <SettingsRow label="정산 계좌">
              <div className="space-y-1">
                ...
                <div className="text-[11px] text-muted-foreground">예금주: 의료법인 글로우업투어 데모</div>
              </div>
            </SettingsRow>
        ...
        <SettingsSectionAnchor id="contracts">
          ...
          >
            <ContractRow name="글로우업투어 데모 에이전시" rate="성형 30% · 피부 20%" deposit="20% percentage" status="active" expiresIn="11개월" />
