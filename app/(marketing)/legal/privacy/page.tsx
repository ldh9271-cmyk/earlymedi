export const metadata = {
  title: '개인정보처리방침 | 글로우업투어',
  description:
    '글로우업투어가 외국인환자와 의료관광 사업자의 개인정보를 어떻게 수집·이용·보호하는지에 대한 공식 처리방침입니다.',
};
...
const PRIVACY_OFFICER_EMAIL = 'ldh9271@gmail.com';
const PRIVACY_OFFICER_PHONE = '02-XXXX-XXXX';
const COMPANY_ADDRESS = '대한민국 서울특별시'; // TODO: 정식 사업장 주소 입력

/**
 * Korean PIPA-compliant privacy policy for the 글로우업투어 medical-tourism SaaS.
 *
 * Required by:
