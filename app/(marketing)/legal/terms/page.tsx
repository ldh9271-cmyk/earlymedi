  ...
  return (
    <main className="prose prose-slate mx-auto max-w-4xl px-6 py-12 prose-headings:tracking-tight prose-h2:mt-12 prose-h2:text-xl prose-h3:mt-6 prose-h3:text-base prose-p:text-sm prose-li:text-sm">
      ...
      <section>
        ...
        <ol>
          <li>
            <strong>무료 체험</strong>: 신규 가입 회원은 가입일부터 30일간 무료로 서비스를 이용할 수
            있습니다. 무료 체험은 회원(사업자)당 1회 제공되며, 별도의 결제 수단 등록 없이 시작됩니다.
          </li>
          <li>
            <strong>유료 전환</strong>: 무료 체험 기간 종료 후 계속 이용하시려면 회원 카테고리별로 적용되는
            유료 플랜에 가입해야 합니다. 플랜별 요금은 /pricing 페이지에 명시되어 있습니다.
          </li>
          <li>
